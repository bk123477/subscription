export const ko = {
    ...
    'form.promoSection': '프로모션 할인',
    'form.promoAmount': '할인된 금액',
    'form.promoUntil': '할인 종료일',
    'form.promoHint': '위 날짜까지 정가 대신 이 금액이 적용됩니다.',
    ...
    'settings.theme.switch': '변경',
    'settings.notifications': '알림 설정',
    'settings.notifications.desc': '결제 전 알림을 받습니다',
    'settings.notifications.enable': '활성화',
    'settings.export': '백업하기',
    'settings.import': '복원하기',
    'settings.seedDemo': '데모 데이터 가져오기',
    'settings.resetData': '모든 데이터 초기화',
    'settings.resetConfirmTitle': '데이터를 초기화할까요?',
    'settings.resetConfirmDesc': '모든 구독 정보와 설정이 영구적으로 삭제됩니다. 이 작업은 되돌릴 수 없습니다.',
